...
namespace X9IncExc {
	public class Init {
		...
		// Public members
		public readonly ValidSwitches_v1 ValidSwitches;
		public readonly ParsedArgs_v1    ParsedArgs;
		...
		public Init(string[] origArgs) {
			...
			// Command-line syntax
			ValidSwitches = new ValidSwitches_v1();
			...
			// Parse args
			ParsedArgs = new ParsedArgs_v1(origArgs, ValidSwitches);
	...
	public class SettingsClass {
		...
		// Constructor
		public SettingsClass(in ParsedArgs_v1 argParsedArgs) {
